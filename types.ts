...
/**
 * Defines the available roles for the autonomous agents.
 * @typedef {'LEAD_ARCHITECT' | 'BACKEND_ENGINEER' | 'SECURITY_SPECIALIST' | 'DEVOPS_ENGINEER' | 'EPISTEMIC_ENGINEER' | 'SYSTEM_ARCHITECT' | 'FRONTEND_ENGINEER' | 'PROJECT_MANAGER' | 'LSP_ENGINEER' | 'FEATURE_DISCOVERY_AGENT'} AgentRole
 */
export type AgentRole = 'LEAD_ARCHITECT' | 'BACKEND_ENGINEER' | 'SECURITY_SPECIALIST' | 'DEVOPS_ENGINEER' | 'EPISTEMIC_ENGINEER' | 'SYSTEM_ARCHITECT' | 'FRONTEND_ENGINEER' | 'PROJECT_MANAGER' | 'LSP_ENGINEER' | 'FEATURE_DISCOVERY_AGENT';
